...
(define (distancia a b) (cond [(and (posn? a) (posn? b)) (expt (+ (expt (- (posn-x b) (posn-x a)) 2) (expt (- (posn-y b) (posn-y a)) 2)) (/ 1 2))]
                              [#t "Tipos incorrectos para la función."]))

(distancia (make-posn 3 4) (make-posn 3 6))